...
Elm.SignupForm.make = function (_elm) {
   ...
   var view = function (model) {
      ...
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Sensational Signup Form")]))
              ...
              ,A2($Html.input,
              _U.list([$Html$Attributes.id("username-field"),$Html$Attributes.type$("text"),$Html$Attributes.value(model.username)]),
              _U.list([]))
              ,A2($Html.label,_U.list([$Html$Attributes.$for("password")]),_U.list([$Html.text("password: ")]))
              ,A2($Html.input,
              _U.list([$Html$Attributes.id("password-field"),$Html$Attributes.type$("password"),$Html$Attributes.value(model.password)]),
              _U.list([]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("signup-button")]),_U.list([$Html.text("Sign Up!")]))]));
   };
   var main = view({username: "",password: ""});
